            ...
            const GPcircle5SVG = circleSVG(690, 120, 50, 'solid', 'blue');
            const GPcircle1SVG = circleSVG(735, 70, 50, 'solid', 'red');
            const GPcircle2SVG = circleSVG(790, 120, 50, 'solid', 'yellow');
            const GPcircle3SVG = circleSVG(735, 170, 50, 'solid', 'green');
            const GPcircle4SVG = circleSVG(735, 120, 10, 'solid', 'black');
